...
- **Adyen Event Entries**: webhook/report events, lifecycle status, source links, retries, errors, Adyen's original reason, and BC's disposition reason. Choose **Open Source** to open the exact originating webhook request or report run.
